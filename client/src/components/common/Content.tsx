  ...
  <div className="main">
    <div className="doc_content">
      <div>
        ...
        <div className="description">
          ...
          <ul>
            ...
            <li> 다양한 사람들을 만나 자유로운 분위기에서 각자의 경험을 나누고 소통할 수 있습니다. </li>
          </ul>
          <ul>
            <li>
      ...
      <div className="vision_wrapper">
        <div>
          ...
          <ul className="square_list_type">
            <li> 우리는 각자의 경험을 나누고 함께 성장하는 것을 추구합니다. </li>
            <li> 막히는 것이 있다면 언제든 편하게 같이 이야기합니다. </li>
            <li> 각자의 자리에서 가진 고민들을 함께 나누며 발전하고 있습니다. </li>
      ...
      <div>
        ...
        <div className="description">
          <ul>
            ...
            <li> 스터디 · 프로젝트 · 세미나 · 외부동아리와의 연계 등 다양한 활동을 진행합니다. </li>
            <li> 아래는 저희가 경험했던 다양한 행사들입니다. </li>
            <li> 이 외에도 아키텍처, 자격증, 기술 서적 등을 기반으로 상시 스터디를 진행하며 성장을 추구하고 있으며, </li>
            <li> 숙명여대 해커톤 클라우드 어시스턴스 참여, AWS re:Invent 참관 등 많은 활동을 해오고 있습니다.</li>
          </ul>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="description">
          <ul>
            <li> 지식의 나눔. 경험의 공유. 천천히 하지만 꾸준한 성장. 앞으로 나아가는 열정. </li>
            <li> . </li>
            <li> 각자 관심있는 주제가 생기면 스터디를 선행하고, 이를 기반으로 프로젝트를 진행합니다. </li>
            <li> 외부 해커톤 및 각종 세미나에 스피커 또는 서포터로 함께 할 예정이며, </li>
            <li> 이번 시즌 저희는 <span style={{ fontSize: "16px", fontWeight: "bold" }}>SOPT</span> 와 함께합니다. </li>
          </ul>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="description">
          <ul>
            ...
            <li> . </li>
            <li> . </li>
            <li> <span style={{ fontSize: "20px", fontWeight: "bold" }}>지원서 제출</span> </li>
            <li> 2021.06.20(일) 23:59 까지 </li>
            <li> <a href="http://bit.ly/ausg-5th"> ▶ 5th AUSG 지원하기 ◀ </a> </li>
          </ul>
        </div>
      </div>
    </div>
