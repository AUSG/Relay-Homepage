...
const CrewCard: React.FC<CrewCardProps> = ({ url, name, introduce, description }) => {
    return (
        <div className="xl:w-1/3 sm:w-1/2 mx-auto sm:max-w-xs mb-20 xl:max-w-sm lg:w-1/2 relative">
            <div className="bg-top bg-cover bg-no-repeat h-64">
                ...
                <div className="opacity-0 hover:opacity-100 hover:bg-opacity-30 bg-black duration-300 absolute inset-0 z-100 flex justify-center items-center text-2xl text-white font-semibold">{description}</div>
            </div>
